            ...
            <ul className="w-full relative h-full flex justify-center items-center gap-5 px-5 md:px-15 pb-1">
                {projects.map(p =>
                    <motion.li
                        ...
                        <img src={p.imagen} alt={p.nombre} className={`w-full h-full object-cover rounded-3xl  hover:brightness-100 ${activeProject?.id === p.id ? "brightness-100" : "brightness-50"}  transition-all duration-300`} />
                    </motion.li>
                )}
