        ...
        >
            <div className="text-3xl flex justify-center pb-10">
                <h4 className="mb-5
                    ...
                    text-6xl">Mis Proyectos</h4>
            </div>
            <div className="w-full pb-[2rem] px-10 ">
                <article className="w-full bg-[black] rounded-3xl flex flex-col justify-end inset-shadow-[0px_-50px_50px_0px_#c528b138]">
                    <div className="text-[#fff] p-10 flex flex-col gap-5">
                        <h3 className="text-3xl">Titulo del proyecto</h3>
                        <h5 className="text-xl">Subtitulo del proyecto</h5>
                        <p className="w-200 text-[#2076E0]">Descripción del proyecto Lorem ipsum dolor sit, amet consectetur adipisicing elit. Praesentium, consequatur blanditiis sed quia odit sint quaerat magnam, ea nam quasi aliquam. Aut facere consectetur iste magni. Mollitia, consequatur exercitationem! Quae!</p>
                        <motion.button
